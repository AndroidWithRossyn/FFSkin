...
public class QricaMeduimAdapter extends PagerAdapter {
    int[] image;
    Context context;

    public QricaMeduimAdapter(int[] image, Context context) {
        this.image = image;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View view= LayoutInflater.from(context).inflate(R.layout.banner_medim_lay,container,false);
